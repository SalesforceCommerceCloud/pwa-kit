...
import {fetchProductsGetCategory, fetchSearchProducts} from '@/app/utils/api/commerce-client.server'
import ProductGrid from '@/app/components/productGrid'
import CategoryBreadcrumbs from '@/app/components/categoryBreadcrumbs'
...
export async function loader({request, params}: LoaderFunctionArgs): Promise<{
    ...
    const [searchResult, category] = await Promise.all([
        fetchSearchProducts(session.data, {categoryId, limit, page, sort, refine}),
