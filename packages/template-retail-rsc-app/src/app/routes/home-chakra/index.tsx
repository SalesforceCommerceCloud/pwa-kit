...
// Skeleton component for Chakra product scroller loading
function ChakraProductScrollerSkeleton() {
    return (
        <div className="py-16">
...
export default function HomeChakra(): ReactElement {
    return (
        <>
            ...
            {/* Chakra ProductScroller Island - Client Component with Suspense */}
            <Suspense fallback={<ChakraProductScrollerSkeleton />}>
                <div className="py-16">
                    <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
                        <ChakraProductScrollerIsland title="Shop Products" />
                    </div>
                </div>
            </Suspense>
