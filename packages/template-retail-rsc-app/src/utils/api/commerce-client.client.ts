...
import { CommerceClientContext } from '@/providers/commerce.client';
import { createQueryClient } from '@/utils/api/commerce-client';
import { createProductsGetCategoryQuery } from '@/utils/api/commerce-client-queries';
...
export const useProductsGetCategory = (
    ...
    queryParameters: Partial<
        Parameters<typeof useQuery<ShopperProductsTypes.Category>>[0]
    > = {}
