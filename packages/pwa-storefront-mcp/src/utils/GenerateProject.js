...
export function generatePwaKitProject(args = []) {
    console.error('generatePwaKitProject', args)
    return new Promise((resolve, reject) => {
        // const cliPath = path.resolve(process.cwd(), 'node_modules', '.bin', 'pwa-kit-create-app')
        const child = spawn(
            'node',
            [
                '/Users/bchypak/Projects/pwa-kit/packages/pwa-kit-create-app/scripts/create-mobify-app.js',
                ...args
            ],
