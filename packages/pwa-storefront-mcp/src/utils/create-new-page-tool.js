...
class CreateNewPageTool {
    constructor() {
        ...
        this.description =
            'Create a sample PWA storefront page. Gather information from user for the MCP tool parameters **one at a time**, in a natural and conversational way. Do **not** ask all the questions at once. Do **not** assume all pramaters are present and automatically create new pages, always ask the user to provide the information one at a time.'
        this.inputSchema = {
