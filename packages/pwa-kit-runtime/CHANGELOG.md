## v3.10.1 (Oct 27, 2025)
- Add extensibility hooks for SLAS private client proxy with `onSLASPrivateProxyReq` and `onSLASPrivateProxyRes` callbacks ; original PR :[#3411](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/3411)
