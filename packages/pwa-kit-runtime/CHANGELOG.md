## v3.19.0-dev
- Update `engines.node` to `^18.19.0 || ^20.6.0 || ^22.0.0 || ^24.0.0` to reflect actual Node.js requirements from OpenTelemetry v2 (`^18.19.0 || >=20.6.0`) and mrt-utilities 0.2.2 (AWS SDK 3.x requires `>=20`). Previous `^18.0.0` was inaccurate after dependency upgrades. [#XXXX](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/XXXX)
