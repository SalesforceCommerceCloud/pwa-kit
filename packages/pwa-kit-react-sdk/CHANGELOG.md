...
- Add server side rendering performance metrics via query parameter `__server_timing`, the metrics is available in the response header `server-timing`. [#1895](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/1895)
