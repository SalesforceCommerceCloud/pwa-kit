...
;(function(undefined) {
    !(function(e, r) {
        ...
        function r(e) {
            for (var t in e)
                (e instanceof r || Me.call(e, t)) &&
                    Ie(this, t, {value: e[t], enumerable: !0, writable: !0, configurable: !0})
        }
        function t() {
            ...
            for (var i = 1, o = t.length; i < o; i++)
                Me.call(ur.subtags, t[i])
                    ...
                    : Me.call(ur.extLang, t[i]) &&
                      ...
                      1 === i && ur.extLang[t[1]][1] === t[0] && ((t = qe.call(t, i++)), (o -= 1)))
            return Ze.call(t, '-')
        }
        function m() {
            return cr
        ...
        function p(e, t) {
            for (var n = 0, a = t.length, i = void 0, o = void 0, s = void 0; n < a && !i; )
        ...
        function j(e, t, n) {
            ...
            for (var s in o)
                Me.call(o, s) && Ie(o, s, {writable: !1, configurable: !1, value: o[s]})
        ...
        function R(e, r) {
            for (var t = {_: {}}, n = 0; n < br.length; n += 1)
                e[br[n]] && (t[br[n]] = e[br[n]]), e._[br[n]] && (t._[br[n]] = e._[br[n]])
            for (var a = 0; a < wr.length; a += 1)
                r[wr[a]] && (t[wr[a]] = r[wr[a]]), r._[wr[a]] && (t._[wr[a]] = r._[wr[a]])
            return t
        }
        function q(e) {
            return (
        ...
        function C(e, r) {
            switch (e.charAt(0)) {
                ...
                case 'e':
                    return (
                        (r.weekday = ['numeric', '2-digit', 'short', 'long', 'narrow', 'short'][
                            e.length - 1
                        ]),
                        '{weekday}'
                    )
                ...
                case 'K':
                    return (
                        (r.hour12 = !0), (r.hour = 2 === e.length ? '2-digit' : 'numeric'), '{hour}'
                    )
                case 'm':
        ...
        function Z(e) {
            ...
            for (i in t)
                t.hasOwnProperty(i) && ((o = t[i]), (s = G(i, o)), s && (a.push(s), u.push(s)))
            for (i in n)
                n.hasOwnProperty(i) && ((o = n[i]), (s = G(i, o)), s && (a.push(s), g.push(s)))
        ...
        function K(e, a, i) {
            ...
            var j = void 0,
                ...
                k = Y(z.formats)
            if (
                ((f = D(i, 'formatMatcher', 'string', new t('basic', 'best fit'), 'best fit')),
                (z.formats = k),
                'basic' === f)
            )
                j = W(g, k)
        ...
        function Q(e, r) {
            ...
            for (
                var i = a['[[locale]]'],
                    ...
                    s = new mr.NumberFormat([i], {minimumIntegerDigits: 2, useGrouping: !1}),
                ...
                function e(e, r) {
                    ...
                    try {
                        for (
                            ...
                            !(n = (o = s.next()).done) && (t.push(o.value), !r || t.length !== r);
                            n = !0
                        );
                    } catch (e) {
                        ;(a = !0), (i = e)
        ...
        Ie(mr.NumberFormat.prototype, 'resolvedOptions', {
            ...
            value: function() {
                ...
                for (var i = 0, o = n.length; i < o; i++)
                    Me.call(a, (e = '[[' + n[i] + ']]')) &&
                        (t[n[i]] = {value: a[e], writable: !0, configurable: !0, enumerable: !0})
                return Re({}, t)
            }
        })
