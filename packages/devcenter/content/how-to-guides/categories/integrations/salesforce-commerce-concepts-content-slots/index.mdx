---
title: 'Salesforce Commerce Concepts: Content Slots'
metaTitle: 'Salesforce Commerce Concepts: Content Slots'
metaDescription: "Part of an advanced series to help you tackle the most challenging topics when integrating Salesforce Commerce with your Mobify app. This lesson covers additional checkout features."
...
This guide builds on lesson two in this series, on [checkout](/how-to-guides/categories/integrations/salesforce-commerce-concepts-checkout). In this lesson, we will learn a workaround for accessing content slots, without risking the security issues associated with making a request with the Salesforce Business Manager password.
...
To continue learning about Salesforce Commerce concepts, check out our next lesson, which is all about [Troubleshooting](/how-to-guides/categories/integrations/salesforce-commerce-concepts-troubleshooting).
