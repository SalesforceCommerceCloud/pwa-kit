---
title: 'Salesforce Commerce Concepts: Checkout'
metaTitle: 'Salesforce Commerce Concepts: Checkout'
metaDescription: "Part of an advanced series to help you tackle the most challenging topics when integrating Salesforce Commerce with your Mobify app. This lesson covers the session bridging problem, and some common tactics to address it."
...
This guide builds on lesson one in this series, on session bridging. (If you haven’t covered it yet, we suggest [starting there](/how-to-guides/categories/integrations/salesforce-commerce-concepts-session-bridging).) There are a few checkout features that are *not* handled by session bridging. In this lesson, you will learn about those checkout features and some tips as you devise your approach, so you can limit the likelihood of getting stuck along the way. 
...
There are a few checkout features that deserve special attention, as they are not handled by [session bridging](/how-to-guides/categories/integrations/salesforce-commerce-concepts-session-bridging):
...
To continue learning about Salesforce Commerce concepts, check out our next lesson, which is all about [Content Slots](/how-to-guides/categories/integrations/salesforce-commerce-concepts-content-slots).
