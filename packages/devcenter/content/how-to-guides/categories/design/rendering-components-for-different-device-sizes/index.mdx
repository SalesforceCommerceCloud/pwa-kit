...
:::note
If you'd like to learn more about the React-Responsive library and the <code>MediaQuery</code> component, you can review the [React-Responsive](https://github.com/contra/react-responsive).
:::
