...
**Note:** You can also manage redirects by using the [Mobify Cloud API](/apis-and-sdks/mobify-cloud) or by extending your project’s [App Server](/get-started/architecture/app-server-overview) code.
...
**Note:** The Admin, Developer, and Deployer role types can also manage redirects in Mobify Cloud. The Read Only and Designer role types can only view redirects.
...
**Important:** When you clone redirects, you’re replacing _all_ the redirects in the production target with _all_ the redirects in the staging target.
