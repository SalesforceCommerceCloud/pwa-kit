---
title: Using Lazy Loading to Improve Perceived Performance
metaTitle: Using Lazy Loading to Improve Perceived Performance
metaDescription: "A guide for interaction designers. Learn about the lazy loading technique and how you can use it to improve your shoppers' perceptions of load speed."
category: Design
featured: false
---
...
Related Links:
* [LazyLoader](/apis-and-sdks/component-library/components/LazyLoader)
...
<figure style="text-align: center">
 ...
 <figcaption>
  ...
  [Lancome](https://www.lancome-usa.com) uses the LazyLoader component with customized fade in animation
...
<figure style="text-align: center">
 ...
 [Mackage](https://www.mackage.com) uses a "Load More Button" for loading more products in on their PLP
