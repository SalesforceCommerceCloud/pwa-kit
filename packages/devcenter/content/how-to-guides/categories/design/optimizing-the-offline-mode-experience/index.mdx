---
title: Optimizing the Offline Mode Experience
metaTitle: Optimizing the Offline Mode Experience
metaDescription: "Create offline mode functionality with Mobify's offline components and the service worker."
category: Design
minVersion: 2.0.0
maxVersion: 2.0.0
featured: false
...
These features are enabled by default in the [Project Scaffold](/get-started/architecture/project-scaffold). There is an additional core feature that is **not enabled** in the Project Scaffold by default:
...
With [Analytics Integrations](/apis-and-sdks/progressive-web-sdk/analytics-integrations/overview), all analytics events will be queued when the user goes offline.
