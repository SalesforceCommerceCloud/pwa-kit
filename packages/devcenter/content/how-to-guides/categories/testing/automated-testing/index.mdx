...
metaTitle: Automated Testing
metaDescription: The Mobify Platform is a Front-end as a Service for ecommerce.
category: Testing
---

<Callout type="warning">
<strong>Important:</strong> Projects generated after January 2019 use the <a href="./mobify-test-framework">Test Framework</a>. For anyone working on projects that were generated before January 2019, we've left the automated testing documentation here in case you still need to refer to it.
</Callout>
