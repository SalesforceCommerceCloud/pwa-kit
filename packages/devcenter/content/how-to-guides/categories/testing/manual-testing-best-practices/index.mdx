...
metaTitle: Manual Testing Best Practices
metaDescription: "Best practices and tips for manually-testing Progressive Web Apps (PWAs) on the Mobify Platform"
category: Testing
minVersion: 2.0.0
maxVersion: 2.0.0
featured: false
...
* Device Browsers
    ...
    * Check our [browser compatibility](/get-started/architecture/browser-compatibility) page for major device versions
...
* Connect the device via USB to the computer so we’re able to have DevTools open to view the console and network traffic. [More information from Google](https://developers.google.com/web/tools/chrome-devtools/remote-debugging/).
...
For more information about designing for perceived performance, check out [our blog post](https://www.mobify.com/insights/designing-appearance-speed/) on visual design best practices that can convey a sense of speed.

### Key elements

* Scrolling should be smooth. You can check FPS using Chrome DevTools. [More information from Google](https://developers.google.com/web/tools/chrome-devtools/evaluate-performance/).
...
There are ways to throttle your connection using Chrome DevTools in the Network Tab. [More information from Google](https://developers.google.com/web/tools/chrome-devtools/network-performance/network-conditions).
