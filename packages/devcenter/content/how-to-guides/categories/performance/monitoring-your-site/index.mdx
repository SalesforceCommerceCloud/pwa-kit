...
:::note
Talk to your Mobify contact to access a dashboard tool for cache hit ratios.
:::
...
:::note
404 errors don’t always mean something went wrong. For example, a 404 error is the correct response when a user visits a URL for a page that doesn’t exist.
:::
