...
:::note
Before you follow this guide, we recommend reading our [overview of the request processor](/get-started/architecture/deployment-infrastructure/#request-processor).
:::
