...
:::note
The App Cache should be queried immediately after the [App Server](/get-started/architecture/app-server-overview) receives a request. This way, if a response is found in the cache, it will be returned as quickly as possible.
:::
