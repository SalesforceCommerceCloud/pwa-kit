...
metaDescription: Best practices for writing your PWA
...
The [Integration Manager](../../../resources/ecommerce-integrations/ecommerce-overview) is a library of
...
- **Are you trying to add a React component library?**
    ...
    You'll find many common components in the [Progressive Web SDK Component library](../../../apis-and-sdks/component-library).
...
Both the [LazyLoader](../../../apis-and-sdks/component-library/components/LazyLoader) and [ScrollTrigger](../../../apis-and-sdks/component-library/components/ScrollTrigger) components can be used to lazy load content on your PWA.
