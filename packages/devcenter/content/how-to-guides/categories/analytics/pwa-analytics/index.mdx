...
metaDescription: Get to know the differences between your PWA’s analytics and traditional website analytics and learn how you can change your analytics implementation to support your PWA.
category: Analytics
---
...
The [Mobify Analytics Manager](../../../apis-and-sdks/progressive-web-sdk/analytics-integrations/analytics-manager) makes this process much easier. When you add an analytics script to the PWA, you will now add all your logic for loading and using the script to an analytics connector. This analytics connector is then registered with the Analytics Manager. Whenever an event occurs in the PWA, the Analytics Manager notifies all of the analytics connectors about the event occurrence.
...
Keen to continue learning about PWA analytics? As a next step, we recommend brushing up on our [Analytics Manager documentation](../../../apis-and-sdks/progressive-web-sdk/analytics-integrations/analytics-manager).
