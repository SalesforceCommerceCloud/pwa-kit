---
title: Adding the Analytics Manager
metaTitle: Adding the Analytics Manager
metaDescription: The Analytics Manager is available for version 0.15.0 and later of Mobify's progressive-web-sdk. Here's how to add the Analtyics Manager to your project files.
category: Upgrades
---
...
```
Please read the [Analytics Schema](../../../apis-and-sdks/progressive-web-sdk/analytics-integrations/legacy-analytics-manager) for
