...
This parameter specifies the version of Node.js used to run the SSR server and [request processor](../../../how-to-guides/categories/performance/request-processor).
