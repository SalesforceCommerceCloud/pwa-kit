---
title: Node.js 10
metaTitle: Node.js 10
metaDescription: Mobify targets are the environments that run your app using Node.js. Previously, targets used Node.js version 8.10.x but that's changing going forward, as version 8 will be discontinued in January 2020.
category: Upgrades
---
<Callout type="info">
...
This is a requirement for customers to fulfill their responsibilities within Mobify's [shared responsibility model](../../../../get-started/support/support-policy#shared-responsibility-model). Typically, Node.js upgrades will happen every two years.

Please follow these instructions to deploy a Node.js 10.x bundle to your `production` target:

1. In your project’s `package.json` file, update `progressive-web-sdk` to a version which supports Node.js 10. We recommend updating to version [`1.11.3`](../../../release-notes/archive/2019-09), or patch version `1.13.2`.
...
This parameter specifies the version of Node.js used to run the [SSR server](https://docs.mobify.com/progressive-web/latest/utility-functions/reference/SSRServer.html) and [request processor](../../../how-to-guides/categories/guides/request-processor).
...
6. [Push](../../../apis-and-sdks/mobify-cloud/overview#pushing-the-bundle) a new bundle and [publish](../../../apis-and-sdks/mobify-cloud/overview#publishing-a-bundle) it to a non-production target.
