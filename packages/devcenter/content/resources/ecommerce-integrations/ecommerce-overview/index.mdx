---
title: Ecommerce Integrations Overview
metaTitle: Ecommerce Integrations Overview
metaDescription: The Integration Manager provides an abstraction layer between your progressive web app and the source of its ecommerce data. This data can come from a dedicated ecommerce platform, a desktop website, or a custom API.
column: 3
---
...
<figure class="u-text-align-center" style="background-color: #fafafa; max-width: 600px">
  ...
  ![Integration Manager
  architecture](images/mobify-backend-analyticsmanager_complexdiagram_june2017_1085.png)
  <figcaption><small>(Click the image for a larger version.)</small></figcaption>
...
**What's a thunk action?** A thunk action is a function is dispatched as an action by the [Redux Thunk](https://github.com/reduxjs/redux-thunk) middleware. The middleware provides two parameters
to the thunk: the `dispatch` function from Redux for dispatching other actions and a
