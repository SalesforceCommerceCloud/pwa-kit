...
metaTitle: September 2018 Release Notes
metaDescription: September 2018 Release Notes
...
For more information, please see the [Commerce Integration Docs](../../apis-and-sdks/commerce-integrations/overview)
...
Performance Manager was an early access addition to the SDK in the last release. For this release, we enabled Performance Manager by default. All projects can now take advantage of optimizations that bring down Time to Interactive metrics via Task Splitting, Download Management and deferring of lower priority work. [Detailed documentation](../../how-to-guides/categories/guides/performance) is available on how Performance Manager can be used within projects.
