---
title: November 2017
metaTitle: November 2017 Release Notes
metaDescription: November 2017 Release Notes
...
We now offer enhanced support for multiple development or staging environments. Our customers typically have multiple development environments to support in the form of production, staging, QA, and developer test environments. Prior to this release, each development environment required it's own [Mobify tag](../../get-started/getting-started/installation#installing-the-mobify-tag). Any Mobify tag changes would require re-generating multiple Mobify tags. A single tag can now load different bundles designated by the environment's hostname.
...
### AMP Layouts
On the UI kit's Best Practice Layouts page we've introduced AMP layouts. These represent Mobify's tried and tested techniques for composing AMP templates using the Mobify AMP SDK suite of components.
