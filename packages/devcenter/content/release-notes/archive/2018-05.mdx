---
title: May 2018
metaTitle: May 2018 Release Notes
metaDescription: May 2018 Release Notes
...
Existing projects looking to leverage Webpack 4 can follow our [upgrade guide](../../how-to-guides/categories/upgrades/webpack-4) to do so.
...
More information on this connector, including how to track additional events, can be found in our [Analytics Documentation](../../apis-and-sdks/progressive-web-sdk/analytics-integrations/legacy-analytics-manager#extending-the-adobe-dynamic-tag-management-connector).
