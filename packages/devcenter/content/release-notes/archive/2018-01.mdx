---
title: January 2018
metaTitle: January 2018 Release Notes
metaDescription: January 2018 Release Notes
...
As part of integrating react-intl, we introduced breaking changes to currencies to get that integration working.

### Accelerated Mobile Pages

#### AMP deployment interface
Now your whole team can preview and manage changes to your AMP pages. Similar to PWA deployments, you can now upload an AMP bundle to our Mobify Cloud dashboard, and from there your team can preview the AMP pages and put your AMP bundle into production. Previously teams could only manage deployments via the command line interface.
...
Almost every enterprise ecommerce deployment will integrate a 3rd party A/B or multivariate testing solution. Integrating these solutions can be complex due to their lack of support for single page applications. As a better starting point for developers looking to complete an integration, we have released:
  * General guidelines, limitations and recommendations for [any multivariate integration](../../how-to-guides/categories/guides/ab-testing)
  * New PWA components to assist with integrations for creating [audience splits](../../apis-and-sdks/component-library/components/Split), and [exposing PWA APIs](../../apis-and-sdks/component-library/components/ExposeApiBase) to multivariate experiences
  * Cookie management for integrating cookie modifications from multivariate experiences
  * A connector for [Monetate](http://monetate.com/) based on the [Analytics Manager](../../apis-and-sdks/progressive-web-sdk/analytics-integrations/legacy-analytics-manager) framework, which will send all required data to Monetate to leverage as many of the Monetate capabilities as possible. Data sent includes page views, product views and transactional information.
...
See the updated documentation for [building](../../resources/ecommerce-integrations/building-a-connector) and [extending](../../resources/ecommerce-integrations/extending-a-connector) a connector, along with the [upgrade guide](../../resources/ecommerce-integrations/upgrade/)
...
As part of expanding developer support for the previously released [Analytics Manager](../../apis-and-sdks/progressive-web-sdk/analytics-integrations/legacy-analytics-manager) framework, the following documentation has been updated:
  * Standard User Interaction events have been documented along with a standard naming scheme
  ...
  * Transactional events such as product impressions, clicks and details have been documented to track when products are viewed and clicked as part of a shopper journey

<p class="c-label c--bugs">Bug Fixes</p>

  * `SelectorRouter` and `Query Router` have been updated to support `fetchAction` and `fetchURL`. 
