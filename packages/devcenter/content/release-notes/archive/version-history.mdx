...
You can also use our handy [DebugInfo SDK Component](../../apis-and-sdks/component-library/components/DebugInfo). This Component is a helpful tool for developers throughout the build, bringing together several important sources of information including the version of `progressive-web-sdk`. Just place the Component anywhere on a page, and it will automatically retrieve the available information.
...
|------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|---------------------------|
| [Mobify API: Target Management](../../apis-and-sdks/mobify-cloud/rest-api#List%20Targets)                           | An API for partner and customer developers to manage their own deployment targets.                                                                                                                                                            | [July 2, 2019](../archive/2019-07)                                       | v1.11.0 and later        |
| Synchronized versioning                                                                                                | Beginning in July 2019, all packages and libraries within the monorepo are all synchronized, released at the same time under the same version. (Previously, each library had its own unique version.)                                         | [July 2, 2019](../archive/2019-07)                                       | v1.11.0 and later        |
| [Analytics Integrations](../../apis-and-sdks/progressive-web-sdk/analytics-integrations/overview)                   | Mobify's API to integrate analytics services. Replaces the [Analytics Manager](../../how-to-guides/categories/upgrades/analytics-manager), and is intended to give developers more control over their analytics implementation.            | [July 2, 2019](../archive/2019-07)                                       | v1.11.0 and later        |
| Documentation site redesign                                                                                            | New documentation site look and feel.                                                                                                                                                                                                         | [March 28, 2019](../archive/2019-03)                                     | v1.9.0 and later         |
| [Mobify Test Framework](../../how-to-guides/categories/testing/mobify-test-framework)                              | A package of testing tools for end to end and performance testing.                                                                                                                                                                            | [January 10, 2019](../archive/2019-01)                                   | v1.0.4-alpha.0 and later |
| New project starting point                                                                                             | Generated projects come with a starting point “scaffold”, essentially a template with some of the foundational PWA Components already implemented. Note that project starting points are not released as part of the product release process. | [January 10, 2019](../archive/2019-01)                                   | v1.0.4-alpha.0 and later |

### 2018

| Technology                                                                                                                     | What is it?                                                                                                                              | Release Date                                                             | Applicable Versions |
|--------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|---------------------|
| [Server-Side Rendered Progressive Web Apps (PWAs)](../../get-started/architecture/overview#2-server-side-rendered-pwas)    | Server-side rendering architecture, enabling Mobify’s fastest PWAs to date. (Originally called Universal Progressive Web Apps or UPWAs.) | [November 15, 2018](../archive/2018-11)                                  |v1.6.0 and later    |
| [Commerce Integrations](../../apis-and-sdks/commerce-integrations/overview)                                                | API to integrate ecommerce backends. Replaces [Integration Manager](../../resources/ecommerce-integrations/ecommerce-overview).       | [September 27, 2018](../archive/2018-09)                                 | v1.0.0 and later   |
| [Performance Manager](../../how-to-guides/categories/guides/performance)                                                     | An SDK tool which allows partner and customer developers to control and configure features that affect PWA performance.                  | [August 16, 2018](../archive/2018-08)                                    | v1.4.0 and later   |

### 2017

| Technology                                                     | What is it?                                                                                                                            | Release Date  | Applicable Versions  |
|----------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|---------------|----------------------|
| [Integration Manager](../../resources/ecommerce-integrations/ecommerce-overview) | API to integrate ecommerce backends. (Replaced in 2018 by [Commerce Integrations](../../apis-and-sdks/commerce-integrations/overview).) | June 22, 2017 | v0.15.0 to v1.4.0 inclusive |
| [Mobify UI Kit](../../how-to-guides/categories/design/mobify-ui-kit/)       | A ready-to-use collection of Sketch design files that pair with Mobify’s SDK Components to build ecommerce pages.                      | May 25, 2017  | v0.15.0 and later   |
| [Analytics Manager](../../how-to-guides/categories/upgrades/analytics-manager) | API to integrate analytics services. (Replaced in 2019 by [Analytics Integrations](../../apis-and-sdks/progressive-web-sdk/analytics-integrations/overview).) | May 24, 2017  | v0.15.0 to v1.10.0 inclusive |

### 2016

| Technology                    | What is it?                                                                                                      | Release Date  | Applicable Versions |
|-------------------------------|------------------------------------------------------------------------------------------------------------------|---------------|---------------------|
| [Progressive Web SDK](../../apis-and-sdks/progressive-web-sdk) | Mobify’s core Software Development Kit. Includes a set of components and utilities for building performant PWAs. | July 28, 2016 | v0.0.1 and later   |
