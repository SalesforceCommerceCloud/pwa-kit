...
-   Mobify customers using server-side rendering must upgrade to Node.js 10 by January 1st, and we’ve already been spreading the word to affected customers. For more details on how you can upgrade your server-side rendered application, visit our [Node.js upgrade instructions](https://dev.mobify.com/v1.x/how-to-guides/categories/upgrades/node).
...
-   Mobify customers with AMP projects must upgrade to Node.js 10 by January 1st, and we've already been spreading the word to affected customers. For more details on how you can upgrade your AMP application, visit our [Node.js upgrade instructions](https://dev.mobify.com/v1.x/how-to-guides/categories/upgrades/node).

### Progressive Web Apps

#### Redeploying Bundles using the Mobify Cloud API

Back in July we released the [Mobify Cloud API](/apis-and-sdks/mobify-cloud), which had an initial focus on target management. This release we’ve started to expand the API with new functionality:
...
To use the new feature, check out our [Mobify Cloud API Reference docs](/apis-and-sdks/mobify-cloud).
