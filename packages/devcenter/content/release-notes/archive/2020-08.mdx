...
The existing [docs.mobify.com](https://docs.mobify.com/), home of all V1 SDK documentation, is scheduled for sunset in Q4 2020. We have migrated all V1 SDK documentation over to [dev.mobify.com/V1.x](http://dev.mobify.com/V1.x), which features an improved navigation and search experience. 
...
We have also made available an [OpenAPI definition](https://swagger.io/specification/) for the [Mobify Cloud APIs](https://docs.mobify.com/openapi/cloud/openapi-schema.json), which can be used with API tools like [Postman](https://www.postman.com/) to explore or auto-generate API client libraries in any programming language of choice. 
