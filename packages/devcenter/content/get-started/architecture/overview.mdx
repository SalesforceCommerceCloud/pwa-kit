...
metaDescription: Architecture Overview
---
...
To learn more about routing, read our guide to [Routing URLs](/how-to-guides/categories/guides/routing).
...
To learn more, visit our [Analytics Manager docs](../../apis-and-sdks/progressive-web-sdk/analytics-integrations/overview).
...
### Mobify SDK libraries

- [**Mobify SDK Component Library**](../../apis-and-sdks/component-library)
...
- [**Commerce Integrations**](../../apis-and-sdks/commerce-integrations/overview)
  ...
  - Developed and maintained by Mobify
- [**Analytics Manager**](../../apis-and-sdks/progressive-web-sdk/analytics-integrations/overview)
  - Package name: included within `progressive-web-sdk`
  - Provides an abstraction layer between your PWA and your analytics platform(s)
  - Developed and maintained by Mobify
- [**Mobify Test Framework**](../../how-to-guides/categories/testing/mobify-test-framework)
...
- [**Susy**](https://www.oddbird.net/susy/)
  - Package name: `susy`
  - Helps you build readable and robust responsive grid systems. To learn more, read [Creating Responsive Layout Grids With Susy](../../how-to-guides/categories/guides/responsive-grid).
