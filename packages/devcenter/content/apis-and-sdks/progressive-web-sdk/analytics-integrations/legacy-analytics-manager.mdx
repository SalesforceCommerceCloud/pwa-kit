---
title: Analytics Manager (deprecated)
metaTitle: Analytics Manager (deprecated)
metaDescription: The the Analytics Manager is an abstraction layer between your PWA and analytics services, such as Google Analytics.
type: 'doc'
category: Analytics Integrations
subcategory: Analytics Manager (deprecated)
---
<Callout type="warning">
    <strong>Important:</strong> Projects generated <em>after</em> June 2019 do not use the Analytics Manager because it has been replaced with our <a href="./overview">Analytics Integrations</a> API. For anyone working on projects that were generated before June 2019, we've left the Analytics Manager documentation here in case you still need to refer to it.
</Callout>
...
![Screenshot of Google analytics requests](images/analytics-request-with-gear.png)
...
![gtm-trigger-setup](images/gtm-trigger-setup.png)
</figure>
...
![gtm-tag-setup](images/gtm-tag-setup.png)
</figure>
...
1. Create a file in `web/app/utils/analytics` with the following code in it.
  ...
  1.1. Login to Monetate dashboard.

  1.2. Click on **Integration**.
    <figure class="u-text-align-center" style="background-color: #fafafa; max-width: 400px">

    ![find-monetate-tag](images/find-monetate-tag.png)
    </figure>

    1.3. Click on **Tag**.

    1.4. Make sure the **ASYNCHRONOUS** button is showing and copy the highlighted url.
    <figure class="u-text-align-center" style="background-color: #fafafa; max-width: 600px;">

    ![monetate-tag](images/monetate-tag.png)
    </figure>
...
guide](../../../how-to-guides/categories/guides/ab-testing)
...
<figure class="u-text-align-center" style="background-color: #fafafa; max-width: 850px;">

![find-adobe-dtm-tag](images/find-adobe-dtm-tag.png)
</figure>
...
![adobe-dtm-suite-ids](images/adobe-dtm-suite-ids.png)
</figure>
...
![adobe-dtm-debugger](images/adobe-dtm-debugger.png)
</figure>
...
![ee-pageview](images/ee-pageview.png)
</figure>

<figure class="u-text-align-center" style="background-color: #fafafa; max-width: 600px;">

![mobify-ga-pageview](images/mobify-ga-pageview.png)
</figure>
...
<figure class="u-text-align-center" style="background-color: #fafafa; max-width: 500px;">

![ga-currency-code](images/ga-currency-code.png)
</figure>
...
![performance-hard-navigation](images/performance-hard-navigation.png)
</figure>
...
![performance-soft-navigation](images/performance-soft-navigation.png)
</figure>
...
<figure class="u-text-align-center" style="background-color: #fafafa;  max-width: 370px;">

![ee-addtocart](images/ee-addtocart.png)
</figure>
...
![ee-removefromcart](images/ee-removefromcart.png)
</figure>
...
![ee-ui-interaction-button](images/ee-ui-interaction-button.png)
</figure>
...
![ee-ui-interaction-swatch-1](images/ee-ui-interaction-swatch-1.png)
</figure>

<figure class="u-text-align-center" style="background-color: #fafafa;  max-width: 500px;">

![ee-ui-interaction-swatch-2](images/ee-ui-interaction-swatch-2.png)
</figure>
...
![ee-ui-interaction-input-text](images/ee-ui-interaction-input-text.png)
</figure>

<figure class="u-text-align-center" style="background-color: #fafafa; max-width: 500px;">

![ee-ui-interaction-input-checkbox](images/ee-ui-interaction-input-checkbox.png)
</figure>

<figure class="u-text-align-center" style="background-color: #fafafa; max-width: 500px;">

![ee-ui-interaction-input-select](images/ee-ui-interaction-input-select.png)
</figure>
...
![ee-ui-interaction-error-sync](images/ee-ui-interaction-error-sync.png)
</figure>

<figure class="u-text-align-center" style="background-color: #fafafa; max-width: 500px;">

![ee-ui-interaction-error-submit](images/ee-ui-interaction-error-submit.png)
</figure>
