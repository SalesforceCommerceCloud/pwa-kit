...
metaTitle: CheckoutPayment
metaDescription: CheckoutPayment
---
...
Captures the payment information required to complete the purchase. This includes card details and a billing address. The page gives the user a chance to review the details of their cart before placing the order.
...
![](./images/templates/checkout-payment/payment-uikit.png)
...
![](./images/templates/checkout-payment/payment-merlins.png)
