...
-   Blocks work well when they are a tint of the error/success color, however beware of using red-on-red or green-on-green as this is not accessible. [Use this handy tool](https://www.contrastchecker.com) to test the contrast.
