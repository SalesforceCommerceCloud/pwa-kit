...
```jsx react-live=true
<Banner isAlert href="https://www.mobify.com" icon="info" title="info">
...
-   Be sure to check the contrast of text on background color to ensure it passes a11y guidelines. [Use this handy tool to guide you](https://www.contrastchecker.com).
