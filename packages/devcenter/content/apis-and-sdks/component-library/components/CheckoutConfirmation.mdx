...
metaTitle: CheckoutConfirmation
metaDescription: CheckoutConfirmation
---
...
Gives the customer feedback that their order has been processed. A secondary purpose of this page is to offer guest users the chance to create an account.
...
![](./images/templates/checkout-confirmation/confirmation-uikit.png)
...
![](./images/templates/checkout-confirmation/confirmation-merlins.png)

#### Lancome

![](./images/templates/checkout-confirmation/confirmation-lancome.png)
