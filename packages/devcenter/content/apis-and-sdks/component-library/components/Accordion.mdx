...
Related component: [AccordionItem](AccordionItem).
...
-   Ensure the contrast between your background color and text passes a11y guides. [Use this handy tool](https://www.contrastchecker.com).
