...
<!-- TODO: Update architechture link to point somewhere relevant -->

To continue learning about the Mobify Platform, check out our [Architecture docs](../../get-started/architecture/overview), or try another one of our other hands-on exercises in [Guides](/how-to-guides).
