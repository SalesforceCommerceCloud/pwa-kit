 ...
 *
 * 1. Testing `npx @mobify/create-app` without publishing to the public NPM repo.
...
const runGenerator = () => {
    ...
    const cmd = 'npx'
    const args = ['@mobify/create-app', ...process.argv.slice(2)]
