...
A tool for generating PWA Kit projects based on project templates, such as the [Chakra Storefront](https://developer.salesforce.com/docs/commerce/pwa-kit-managed-runtime/guide/retail-react-app.html).
