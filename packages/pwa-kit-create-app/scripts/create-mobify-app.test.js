...
describe('Create Mobify App - Core Functions', () => {
    ...
    describe('Answer Validation', () => {
        ...
        test('should expand dot notation keys correctly', () => {
            ...
            const result = expandKey('project.deployment.defaultMRTProject', 'my-project')
        ...
        test('should expand object with multiple dot notation keys', () => {
            const expandKey = (key, value) =>
                key
                    .split('.')
                    .reverse()
            ...
            const input = {
                'project.deployment.defaultMRTProject': 'my-project',
                'project.deployment.defaultMRTTarget': 'production',
                'project.name': 'test-app'
            }

            const result = expandObject(input)
