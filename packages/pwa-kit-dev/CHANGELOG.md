...
- Add a test asserting the dev server's `app.sendMetric()` is a backwards-compatible no-op, following removal of custom per-request CloudWatch metrics in `pwa-kit-runtime`.
## v3.19.0 (Jul 13, 2026)
