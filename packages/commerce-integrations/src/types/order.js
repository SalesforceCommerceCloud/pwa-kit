 ...
 * @property {module:@mobify/commerce-integrations/dist/types.CustomerInformation} customerInfo Information about the customer.
 * @property {Array.<module:@mobify/commerce-integrations/dist/types.CartItem>} items The order items.
 * @property {module:@mobify/commerce-integrations/dist/types.OrderAddress} shippingAddress The order's destination shipping address.
 * @property {module:@mobify/commerce-integrations/dist/types.OrderAddress} billingAddress The order's billing address.
 * @property {String} selectedShippingMethodId The selected shipping method for the order.
 * @property {Array.<module:@mobify/commerce-integrations/dist/types.Payment>} payments All the current payments for the order.
