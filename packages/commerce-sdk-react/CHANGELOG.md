...
- [Feature] Extend `ShopperOrdersMutations` with `requestOrderAccessCode` (pending `commerce-sdk-isomorphic` 5.5.0) so `useShopperOrdersMutation('requestOrderAccessCode')` is callable without TypeScript errors when compiled against the current 5.4.0 lockfile. [#3982](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/3982)
## v5.4.0 (Aug 12, 2026)
