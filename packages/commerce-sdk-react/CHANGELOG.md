## v5.3.0-dev
- [Feature] Add `cancelOmsOrder` mutation and `useOmsMetaData` query hooks for Order Management cancel and return flows. Cancel mutation invalidates the order cache on success. [#3864](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/3864)
