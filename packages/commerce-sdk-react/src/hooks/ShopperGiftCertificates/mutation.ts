...
// TODO: Our general convention is GET = query, POST/etc. = mutation. However, this is conceptually
// a query (and is called "get"!); I assume it is a POST because gift certificates are secret.
// Should this be a query hook or a mutation hook?
export const ShopperGiftCertificatesMutations = {
    GetGiftCertificate: 'getGiftCertificate'
} as const

export type ShopperGiftCertificatesMutation =
    (typeof ShopperGiftCertificatesMutations)[keyof typeof ShopperGiftCertificatesMutations]

export function useShopperGiftCertificatesMutation<
    Mutation extends ShopperGiftCertificatesMutation
>(
    mutation: Mutation
