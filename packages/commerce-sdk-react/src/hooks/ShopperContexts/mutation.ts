...
type ShopperContextsMutationType = typeof ShopperContextsMutations[keyof typeof ShopperContextsMutations]

/**
 * A hook for performing mutations with the Shopper Contexts API.
 */
export function useShopperContextsMutation<Action extends ShopperContextsMutationType>(
    action: Action
) {
