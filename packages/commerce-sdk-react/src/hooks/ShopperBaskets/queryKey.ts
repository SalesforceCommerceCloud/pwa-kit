...
type Params<T extends Exclude<keyof Client, 'clientConfig'>> = NonNullable<
    Argument<Client[T]>['parameters']
>
export type QueryKeys = {
    getBasket: readonly ['/organizations/', string, '/baskets/', string, Params<'getBasket'>]
    getPaymentMethodsForBasket: readonly [
        '/organizations/',
        string,
        '/baskets/',
        string,
    ...
    getPriceBooksForBasket: readonly [
        '/organizations/',
        string,
        '/baskets/',
        string,
    ...
    getShippingMethodsForShipment: readonly [
        '/organizations/',
        string,
        '/baskets/',
        string,
