...
;(function(e) {
    ...
    e.widget('toc.tocify', {
                                  ...
                                  .each(function() {
                                      0 === e(this).find(o.options.selectors).length
                                          ? e(this)
                                                ...
                                                .each(function() {
                                                    e(this).is(n) ||
                                                        o._appendSubheaders.call(this, o, s)
                                                })
                                          : e(this)
        ...
        _setActiveElement: function(e) {
            ...
            return (
                i.length
                    ? (s.element.find('.' + s.focusClass).removeClass(s.focusClass),
                      o.addClass(s.focusClass),
                      s.options.showAndHide && o.click())
                    : (s.element.find('.' + s.focusClass).removeClass(s.focusClass),
                      !i.length &&
                          e &&
                          s.options.highlightDefault &&
                          s.element
                              .find(f)
                              .first()
        ...
        _setEventHandlers: function() {
            ...
            this.element.on('click.tocify', 'li', function() {
                if (
                    (i.options.history && (t.location.hash = e(this).attr('data-unique')),
                    ...
                    e(t).on('scroll.tocify', function() {
                        e('html, body')
                            ...
                            .done(function() {
                                ...
                                if (
                                    i.options.extendPage &&
                                    ((i.webkit && h >= c - r - i.options.extendPageOffset) ||
                                        (!i.webkit && r + h > d - i.options.extendPageOffset)) &&
                                    !e(p).length
                                ) {
                                    if (
                                        ((n = e(
        ...
        show: function(t) {
            ...
            if (!t.is(':visible'))
                switch (
                    (t.find(d).length || t.parent().is(h) || t.parent().is(':visible')
                        ? t.children(d).length || t.parent().is(h) || (t = t.closest(d))
                        : (t = t.parents(d).add(t)),
                    s.options.showEffect)
                ) {
                    case 'none':
                        t.show()
                        break
        ...
        _triggerShow: function(e, t) {
            var s = this
            return (
                e.parent().is(h) || e.next().is(d)
                    ? s.show(e.next(d), t)
                    : e.parent().is(d) && s.show(e.parent(), t),
                s
            )
        },
        _addCSSClasses: function() {
            return (
                'jqueryui' === this.options.theme
                    ...
                    ? (this.element.find(h + ',' + d).addClass('nav nav-list'),
