    ...
    if (
        ...
        Prism.hooks.add('before-highlight', function(s) {
            if (s.language && a[s.language] && !a[s.language].initialized) {
                var e = a[s.language]
                'Array' !== Prism.util.type(e) && (e = [e]),
                    e.forEach(function(e) {
                        var i, r, n, g
                        e === !0
                            ? ((i = 'important'), (r = s.language), (e = s.language))
                            : ((i = e.before || 'important'),
                              (r = e.inside || e.lang),
                              (n = e.root || Prism.languages),
                              (g = e.skip),
                              (e = s.language)),
                            !g &&
                                Prism.languages[e] &&
                                ...
                                (s.grammar = Prism.languages[e]),
                                (a[s.language] = {initialized: !0}))
                    })
            }
        }),
                ...
                new Prism.plugins.Previewer(
                    ...
                    function(a) {
                        ...
                        return (
                            (e = (100 * i) / s),
                            (e %= 100),
                            this[(0 > i ? 'set' : 'remove') + 'Attribute']('data-negative', ''),
