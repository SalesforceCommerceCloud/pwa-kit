...
- Introduce optional prop `hybridAuthEnabled` to control Hybrid Auth specific behaviors in commerce-sdk-react [#2658](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/2658)
