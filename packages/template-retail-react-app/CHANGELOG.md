## v10.1.0-dev
- [Bugfix] Apply CX UI text guidelines to order history, order detail, and account addresses: initial-cap status badges (no all-caps), spell "Canceled" with one "l", pluralize item counts ("1 item" vs "N items"), and use button-style capitalization for the "View Details" link and "Cancel Order" button.
