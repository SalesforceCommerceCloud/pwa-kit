...
- Update the direct `commerce-sdk-isomorphic` dependency for the new Shopper Delivery Estimates API support in `commerce-sdk-react`, and increase the `vendor.js` bundle budget from 400 kB to 401 kB for the upgraded SDK.
