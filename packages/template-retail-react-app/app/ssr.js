...
const options = {
    ...
    // If this is enabled, the local server will allow cookies to be set.
    // This is required for SFCC sessions to work and is required for hybrid proxy to work.
    ...
    sfccOrigin: 'https://zzrf-001.dx.commercecloud.salesforce.com/s/RefArchGlobal',
