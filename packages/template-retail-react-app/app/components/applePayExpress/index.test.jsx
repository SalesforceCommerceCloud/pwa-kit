...
jest.mock(
    '@salesforce/retail-react-app/app/components/applePayExpress/utils/shipping-address',
    () => ({
...
jest.mock(
    '@salesforce/retail-react-app/app/components/applePayExpress/utils/shipping-methods',
    () => ({
