...
import SetProductHeaderView from '@salesforce/retail-react-app/app/components/set-product-view/partials/SetProductHeaderView'

/**
 * Render a set product header view that includes name, image gallery, price,
 * variant selections, action buttons
 */
const SetProductHeader = forwardRef(
    (
        {
            product,
            category,
        ...
        }, [showInventoryMessage, childProductOrderability, intl])
...
SetProductHeader.displayName = 'SetProductHeader'

SetProductHeader.propTypes = {
