...
/**
 * This layout component displays its children in a 2 rows x 3 column grid on mobile and desktop
 * and 1 row x 6 columns on desktop.
 * 
...
export const MobileGrid2r3c = ({regions}) => (
    <SimpleGrid className="mobile-2r-3c" columns={{base: 3, md: 6}} spacingX={15} spacingY={15}>
        {regions.map((region) => (
