...
const PricingAndPromotionsSkeleton = () => {
    return (
        <Stack spacing={2} data-testid="sf-product-tile2-pricing-and-promotions-skeleton">
...
export const Skeleton = () => {
    ...
    return (
        <Box data-testid="sf-product-tile2-skeleton">
            <Stack spacing={2}>
...
/**
 * The ProductTile2 is a simple visual representation of a
...
const ProductTile2 = (props) => {
    ...
    return (
        <Box {...styles.container}>
            <Link data-testid="product-tile2" to={productUrl} {...styles.link} {...rest}>
                <Box {...styles.imageWrapper}>
                    <AspectRatio {...styles.image}>
                        <DynamicImage
                            data-testid="product-tile2-image"
                            src={`${
                                image?.disBaseLink ||
                                image?.link ||
                    ...
                    <>
                        ...
                        <Button
                            ...
                            onClick={(e) => {
                                ...
                                onAddToCart(productWithFilteredVariants)
                            }}
                            isLoading={isAddingToCart}
                            isDisabled={!productWithFilteredVariants.variants?.[0]?.orderable}
                            data-testid="product-tile2-add-to-cart-button"
                        >
                            {intl.formatMessage({
                                defaultMessage: 'Add to Cart',
                                id: 'product_tile2.button.add_to_cart'
                            })}
                        </Button>
                    ...
                    <IconButtonWithRegistration
                        ...
                        aria-label={
                            isFavourite
                                ? intl.formatMessage(
                                      {
                                          id: 'product_tile2.assistive_msg.remove_from_wishlist',
                                ...
                                : intl.formatMessage(
                                      {
                                          id: 'product_tile2.assistive_msg.add_to_wishlist',
...
ProductTile2.displayName = 'ProductTile2'

ProductTile2.propTypes = {
    /**
    ...
    /**
     * Callback function to be invoked when adding to cart
     */
