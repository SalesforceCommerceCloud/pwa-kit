...
/**
 * Checkout-specific version of ItemAttributes that only shows attribute values without labels
 */
const CheckoutItemAttributes = ({includeQuantity, currency, excludeBonusLabel, ...props}) => {
...
CheckoutItemAttributes.propTypes = {
