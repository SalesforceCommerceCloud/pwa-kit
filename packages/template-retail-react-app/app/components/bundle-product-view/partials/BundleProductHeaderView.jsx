...
const BundleProductHeaderView = forwardRef((props, ref) => {
    const {
        product,
        category,
        showFullLink,
...
BundleProductHeaderView.displayName = 'BundleProductHeaderView'

BundleProductHeaderView.propTypes = {
    // Define all the prop types as needed for clarity and validation
}

export default BundleProductHeaderView
