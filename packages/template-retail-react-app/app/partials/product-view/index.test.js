...
describe('Product View Component', function () {
    createServer()
    ...
    test('renders with addToWishList event handler', async () => {
    ...
    test('renders with updateWishlist event handler', async () => {
    ...
    test('can update quantity', async () => {
        const addToCart = jest.fn()
        await renderWithProviders(
            <MockComponent product={mockProductDetail} addToCart={addToCart} />
        )
