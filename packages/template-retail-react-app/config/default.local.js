...
module.exports = {
    app: {
        ...
        commerceAPI: {
            ...
            //latest one to come back to
            /*parameters: {
        clientId: 'f66906b0-52df-416e-990d-1ee3757007f4',
        organizationId: 'f_ecom_zyoe_008',
        shortCode: 'sandbox-001',
        siteId: 'RefArch'
    }*/
            /*parameters: {
            ...
            parameters: {
                //clientId: '8ef7c709-471e-4b2e-b453-ef21a4da4e45',
                clientId: '4203bc92-dbb4-4710-9fdc-9e59ea504e7f', //public
                organizationId: 'f_ecom_zyoe_011',
                shortCode: 'sandbox-001',
                siteId: 'RefArch'
            }
        },
    ...
    ssrParameters: {
        ...
        proxyConfigs: [
            ...
            {
                host: 'zyoe-011.dx.commercecloud.salesforce.com',
                path: 'ocapi'
            }
        ]
    }
