...
module.exports = {
    app: {
        url: {
            ...
            basePaths: ['/cn','/in'], // empty by default. can set additional allowed basePaths here
            defaultBasePath: '/test' // empty by default. set this to /basePath to add a default basePath
        },
