...
import {isDataURL, noop, runningServerSide} from '../../utils/utils'
...
class Image extends React.PureComponent {
    ...
    componentDidMount() {
        ...
        const skipPlaceholderBehaviour = isIEEleven() || isDataURL(this.props.src || '')
        ...
        // behaviour.
        const loadThroughSSR = runningServerSide() && !this.props.shouldLazyLoad

        // Finally, update the `loaded` state.
        const loaded = skipPlaceholderBehaviour || hasAlreadyLoaded || loadThroughSSR
