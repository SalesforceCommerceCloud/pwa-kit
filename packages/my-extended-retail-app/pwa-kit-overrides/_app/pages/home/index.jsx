        ...
        <Box data-testid="home-page" layerStyle="page">
            ...
            <Hero
                title={intl.formatMessage({
                    defaultMessage: 'CUSTOM React PWA Starter Store for Retail TEST',
            ...
            {productSearchResult && (
                <Section
                    ...
                    paddingTop={16}
                    title={intl.formatMessage({
                        defaultMessage: 'Shop CUSTOM Products',
                        id: 'home.heading.shop_products'
                    })}
                    subtitle={intl.formatMessage(
                        {
                            defaultMessage:
                                'This section contains content from the CUSTOM catalog. {docLink} on how to replace it.',
            ...
            <Section
                ...
                subtitle={intl.formatMessage({
                    defaultMessage:
                        'CUSTOM Out-of-the-box features so that you focus only on adding enhancements.',
            ...
            <Section
                ...
                subtitle={
                    <>
                        <>
                            {intl.formatMessage({
                                defaultMessage: 'CUSTOM Contact our support staff.',
