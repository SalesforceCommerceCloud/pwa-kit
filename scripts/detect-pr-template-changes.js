        ...
        for (const changedFile of changedFiles) {
            ...
            if (mapping) {
                ...
                for (const template of mapping.templates) {
                    const templatePath = path.join(this.templateDirs[template.templateDir], template.destination)
...
if (require.main === module) {
    ...
    program
        ...
        .description('Detect which files changed in PR have corresponding .hbs templates that may need updates')
